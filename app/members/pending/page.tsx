    ...
    return (
      <main className="min-h-screen bg-[#fafaf5] flex items-center justify-center px-6">
        <div className="max-w-md w-full text-center">
          <p className="text-sm tracking-[0.2em] uppercase text-[#a58e28] mb-10">Luxury Talent Intelligence, Powered by Contribution.</p>
          <div className="bg-white border border-[#e8e2d8] rounded-sm p-8">
            ...
            <h3 className="jl-serif text-xl text-[#1a1a1a] mb-2">Welcome</h3>
      ...
      <main className="min-h-screen bg-[#fafaf5] flex items-center justify-center px-6">
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-white border border-[#e8e2d8] rounded-sm p-8">
            ...
            <h3 className="jl-serif text-xl text-[#1a1a1a] mb-2">Pending request</h3>
            <p className="text-sm text-[#666] mb-4">
              {firstName ? `Thank you, ${firstName}.` : 'Thank you.'} Your request is under review.
            </p>
            <p className="text-xs text-[#999]">
              Profiles are subject to approval.
            </p>
          </div>
      ...
      <div className="max-w-2xl w-full">
        <div className="text-center mb-10">
          <h1 className="jl-serif text-2xl md:text-3xl text-[#1a1a1a] mb-2">
            {step === 1 ? 'Select your profile' : 'Complete Your Profile'}
          </h1>
          <p className="text-[#666] text-sm max-w-md mx-auto">
            {step === 1
              ? 'Select the profile that best describes you.'
              : 'Tell us about yourself so we can review your request.'}
          </p>
        </div>

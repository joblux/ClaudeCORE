    ...
    return (
      <main className="min-h-screen bg-[#fafaf5] flex items-center justify-center px-6">
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-white border border-[#e8e2d8] rounded-sm p-10">
            <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-[#fafaf5] border border-[#a58e28] flex items-center justify-center">
              <svg className="w-6 h-6 text-[#a58e28]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h3 className="text-xl text-[#1a1a1a] mb-3" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
              Welcome{firstName ? `, ${firstName}` : ''}.
            </h3>
            <p className="text-sm text-[#666] mb-8 leading-relaxed">Your account has been approved. The intelligence is ready.</p>
  ...
  return (
    <main className="min-h-screen bg-[#fafaf5] flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <div className="bg-white border border-[#e8e2d8] rounded-sm p-10">
          <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-[#fafaf5] border border-[#e8e2d8] flex items-center justify-center">
            <svg className="w-6 h-6 text-[#a58e28]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-sm text-[#666] mb-2 leading-relaxed">Your request is under review.</p>
          ...
          <div className="border-t border-[#f0ece4] pt-6">
            <p className="text-xs text-[#bbb] leading-relaxed">
              ...
              <Link href="/brands" className="text-[#a58e28] hover:text-[#1a1a1a] transition-colors">brand intelligence</Link>
              {' '}or read{' '}
              <Link href="/insights" className="text-[#a58e28] hover:text-[#1a1a1a] transition-colors">the latest insights</Link>.
            </p>
          </div>
        </div>
        <Link href="/" className="text-sm text-[#aaa] hover:text-[#1a1a1a] transition-colors mt-6 inline-block">← Return to homepage</Link>
      </div>
    </main>
  )
}

    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-[#161b22] border border-[#30363d] rounded-b-lg rounded-tr-lg p-6">
        ...
        {tab === 'editions' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-sm font-semibold text-[#c9d1d9]">Editions</h2>
        ...
        {tab === 'blog' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-sm font-semibold text-[#c9d1d9]">Articles</h2>
        ...
        {tab === 'itineraries' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-sm font-semibold text-[#c9d1d9]">Itineraries</h2>
        ...
        {tab === 'hotels' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-sm font-semibold text-[#c9d1d9]">Hotels</h2>
        ...
        {tab === 'cities' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-sm font-semibold text-[#c9d1d9]">City Guides</h2>
        ...
        {tab === 'cruises' && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-sm font-semibold text-[#c9d1d9]">Cruises</h2>

              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-2">
                    ...
                    {m.member_id && (
                      <Link href={`/admin?search=${encodeURIComponent(m.email)}`} onClick={(e) => e.stopPropagation()} className="text-[#a58e28]" title="View profile">
                ...
                <div className="font-sans text-[0.65rem] text-[#a58e28] mb-0.5">{m.category}{m.subcategory ? ` › ${m.subcategory}` : ''}</div>
            ...
            <div className="jl-card sticky top-8">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <div className="font-sans text-xs text-[#888]">{selected.email}</div>
                </div>
              ...
              <div className="font-sans text-[0.6rem] text-[#ccc] mb-4">{new Date(selected.created_at).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric', hour: '2-digit', minute: '2-digit' })}</div>

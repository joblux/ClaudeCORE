    ...
    <>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-white px-4 text-[#999] uppercase tracking-widest">
            or
          </span>
        </div>
      </div>
      ...
      {emailSent ? (
        ...
        <form onSubmit={handleMagicLink}>
          <label
            htmlFor="email"
            className="block text-xs text-[#777] uppercase tracking-wider mb-2"
          >
            Email address
          </label>
          <input

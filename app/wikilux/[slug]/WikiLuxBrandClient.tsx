...
interface WikiLuxBrandClientProps {
  brand: any
...
export default function WikiLuxBrandClient({
  ...
  const [content, setContent] = useState<WikiContent | null>(initialContent)
  const [loading, setLoading] = useState(!initialContent)
  const [images, setImages] = useState<BrandImage[]>(initialImages)
  const [insights, setInsights] = useState<MemberInsight[]>(initialInsights)
  const [insightsTotal, setInsightsTotal] = useState(initialInsightsTotal)
  const [showAllInsights, setShowAllInsights] = useState(false)
  const [editorialNotes, setEditorialNotes] = useState<string | null>(initialEditorialNotes)
  const [contentUpdatedAt, setContentUpdatedAt] = useState<string | null>(initialContentUpdatedAt)
  ...
  const knownForTags = brand.known_for.split(',').map((t: string) => t.trim())
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-[#e8e2d8] p-5">
                      ...
                      <div className="flex flex-wrap gap-2">{knownForTags.map((tag: string) => (<span key={tag} className="font-sans text-[0.6rem] text-[#a58e28] border border-[#e8e2d8] px-2.5 py-1">{tag}</span>))}</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="border-t border-[#e8e2d8]">
            <div className="jl-container py-10">
              ...
              <div className="mt-6 text-center">
                ...
                >
                  Contribute Your Experience at {brand.name}
                </button>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <h2 className="jl-serif text-xl font-light text-[#1a1a1a]">Contribute Your Experience at {brand.name}</h2>
                </div>

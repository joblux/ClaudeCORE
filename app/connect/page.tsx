  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] flex flex-col">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        {/* EMPLOYERS */}
        <Link href="/services/recruitment" className="group flex-1 flex flex-col justify-between p-10 md:p-14 border-b md:border-b-0 md:border-r border-[#1e1e1e] bg-[#0f0f0f] hover:bg-[#121208] transition-colors duration-300 cursor-pointer">
          <div>
            ...
            <p className="text-sm text-[#666] leading-relaxed max-w-sm mb-8">
        ...
        {/* PROFESSIONALS */}
        <Link href="/join" className="group flex-1 flex flex-col justify-between p-10 md:p-14 bg-[#0a0f0c] hover:bg-[#0c130f] transition-colors duration-300 cursor-pointer">
          <div>

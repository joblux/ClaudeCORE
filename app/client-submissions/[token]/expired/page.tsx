...
export default function ClientSubmissionExpired() {
  ...
  const logo = { height: '36px', width: 'auto', marginBottom: '6px', marginLeft: '-14px' }
    ...
    <>
      ...
      <div style={outerStyle}>
        <div style={headlineWrap}>
          <h1 style={headline}>This submission is no longer available.</h1>
        </div>
        <div style={signoff}>

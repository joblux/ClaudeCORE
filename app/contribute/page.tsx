            ...
            {activeTab === 'interview' && (
              <div className="bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg p-5 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div><span className={lc}>Difficulty</span><select className={sc} value={interview.difficulty} onChange={e => setInterview({ ...interview, difficulty: e.target.value })}><option value="">Select</option><option value="easy">Easy</option><option value="moderate">Moderate</option><option value="challenging">Challenging</option><option value="very_challenging">Very challenging</option></select></div>
                </div>

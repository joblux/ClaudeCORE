...
export async function GET(req: NextRequest) {
  ...
  let query = supabase
    .from('members')
    .select('id, email, full_name, first_name, last_name, role, status, city, country, bio, avatar_url, auth_provider, created_at, approved_at, last_login, profile_completeness, cv_url, company_name, org_type', { count: 'exact' })

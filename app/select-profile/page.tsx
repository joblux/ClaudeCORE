    ...
    <div className="min-h-screen">
      <div className="bg-[#1a1a1a] py-8 md:py-10">
        <div className="max-w-[1200px] mx-auto px-7 text-center">
          <div className="text-[10px] font-semibold tracking-[2px] uppercase text-[#a58e28] mb-4">Step 2 of 5 | Select your profile</div>
          <h1 className="text-4xl font-normal text-white mb-5 leading-tight max-w-3xl mx-auto" style={{ fontFamily: 'var(--font-playfair), Georgia, serif' }}>

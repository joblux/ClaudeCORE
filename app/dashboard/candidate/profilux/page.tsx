...
export default function ProfiluxPage() {
  ...
  // G1 — REMOVE is non-destructive (§26.2). Removing an optional section drops
  // its key from activated_sections only; content is retained in its column.
  // Re-adding the section restores prior data via the literal-read resolver.

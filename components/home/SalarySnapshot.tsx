...
export async function SalarySnapshot() {
  ...
  return (
    <div>
      ...
      <Link href="/salaries" className="inline-block mt-2 font-sans text-[0.7rem] font-semibold tracking-[0.1em] uppercase text-[#a58e28] hover:text-[#9a6f0a] transition-colors">
        Full salary guide →
      </Link>
    </div>
  )

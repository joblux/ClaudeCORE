...
export function LatestJobs() {
  return (
    <div>
      ...
      <Link href="/jobs" className="inline-block mt-3 font-sans text-[0.7rem] font-semibold tracking-[0.1em] uppercase text-[#c8960c] hover:text-[#9a6f0a] transition-colors">
        All positions →
      </Link>
    </div>
  )

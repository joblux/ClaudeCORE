...
export function WikiLuxPreview() {
  return (
    <div>
      ...
      <Link href="/wikilux" className="inline-block mt-3 font-sans text-[0.7rem] font-semibold tracking-[0.1em] uppercase text-[#a58e28] hover:text-[#9a6f0a] transition-colors">
        All 500+ maisons →
      </Link>
    </div>
  )

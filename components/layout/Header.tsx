      ...
      <div className="jl-container">
        <div className="flex items-center justify-between py-4 sm:py-5">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-2 w-full max-w-xs mx-6 px-4 py-2 border border-[#d5d0c8] rounded-full text-left hover:border-[#a58e28] transition-colors cursor-text"
          >

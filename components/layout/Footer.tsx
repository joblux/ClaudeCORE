      ...
      <div className="jl-container py-6">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div>
            ...
            <p className="font-sans text-xs text-[#888] leading-relaxed mb-3">Luxury Industry Careers Intelligence</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-16">
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/wikilux" className="font-sans text-xs text-[#888] hover:text-[#1a1a1a] transition-colors">Brand Intelligence</Link></li>
                <li><Link href="/opportunities" className="font-sans text-xs text-[#888] hover:text-[#1a1a1a] transition-colors">Search Assignments</Link></li>
                ...
                <li><Link href="/bloglux" className="font-sans text-xs text-[#888] hover:text-[#1a1a1a] transition-colors">Insights</Link></li>
                <li><Link href="/the-brief" className="font-sans text-xs text-[#888] hover:text-[#1a1a1a] transition-colors">The Brief</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="jl-overline text-[#1a1a1a] mb-3">Private Services</h4>
              <ul className="space-y-2">
                <li><Link href="/services/recruitment" className="font-sans text-xs text-[#888] hover:text-[#1a1a1a] transition-colors">Confidential Recruitment</Link></li>

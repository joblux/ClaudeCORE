    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e8e2d8;">
        ...
        <tr><td style="background:#1a1a1a;padding:20px 32px;text-align:center;">
          ...
          <div style="font-size:9px;color:#666;letter-spacing:3px;margin-top:2px;text-transform:uppercase;">Luxury Industry Careers Intelligence</div>
        </td></tr>
        <!-- Body -->
        ...
        <tr><td style="padding:20px 32px;border-top:1px solid #e8e2d8;text-align:center;">
          <p style="font-size:11px;color:#999;margin:0;">This message was sent via JOBLUX | Luxury Industry Careers Intelligence</p>

...
- **9e70d83** `docs(profilux): canonical UX map capture (v1)` — Adds `docs/PROFILUX_RELOAD_UX_MAP.md` (613 lines) as capture-with-provenance doctrine doc. §13 promotion checklist locks 4 future MATRIX patches. Frozen before Phase 3 audit, used as one of three doctrine anchors for the audit (alongside MATRIX v1.1 + MODEL).
